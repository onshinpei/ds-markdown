export default {
  ...
  navApi: 'API',
  navMermaid: 'Mermaid Chart Demo',
  // API Docs TOC items
  navApiTypedef: 'Type Definitions',
  navApiProps: 'Props',
  navApiRefDs: 'Ref Methods - DsMarkdown',
  navApiRefCmd: 'Ref Methods - MarkdownCMD',
  navApiPlugin: 'Built-in Plugins',
  navApiTimer: 'Timer Comparison',
  navApiFormula: 'Math Formula Delimiters',
  navApiConfig: 'ConfigProvider & i18n',
  navApiBest: 'Best Practices',
  navApiExample: 'Examples',
  demoEffect: 'Effect:',
